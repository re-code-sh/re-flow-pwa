...
import { APP_ACCENTS, type AppAccentCode } from '../theme';
          ...
          {activeSection === 'theme' && (
            <div className="space-y-4 animate-tab-fade">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {(Object.keys(APP_ACCENTS) as AppAccentCode[]).map((key) => {
              ...
              <GlassCard className="p-5 space-y-4 bg-white/[0.03]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <Cloud className="w-5 h-5 text-[var(--accent)] stroke-[1.75]" />
                ...
                {syncKey ? (
                  <div className="p-3.5 rounded-xl bg-[var(--accent-soft)] border border-[var(--accent)]/20 text-[var(--accent)] text-xs flex items-center gap-2">
